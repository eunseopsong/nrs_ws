%% This example is made for UR10

% Update Date: 07/17/2025
...
DH_al = [   0,  pi/2,     0,     0,  pi/2, -pi/2];
DH_a  = [   0,     0,    a2,    a3,     0,     0];
DH_d  = [  d1,     0,     0,    d4,    d5,    d6];
DH_th = [ th1,   th2,   th3,   th4,   th5,   th6];

% Actual value setting to verify (HTM & Jacobian)
VER_a  = [     0,     0,  -612, -572.3,     0,     0]; % Unit: mm
VER_d  = [ 127.3,     0,     0,    164, 115.7,  92.2]; % Unit: mm
VER_th = [ 3.999,-1.374,-2.149, -1.749, 1.111,-0.453]; % Unit: rad
VER_tq = [     0,     1,     0,      0,     0,     0]; % Used in jacobian veri. (Unit: Nm)
