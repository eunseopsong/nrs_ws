...
// void RvizVisul_RPY(const rtde_handarm::VRposRtMsg_RPY::ConstPtr& msg);
// void RvizVisul_Qua(const rtde_handarm::VRposRtMsg_Qua::ConstPtr& msg);
// void posCalRvizCallback(const geometry_msgs::PoseStamped::ConstPtr& msg);
                    ...
                    if(PB_starting_path_done_flag == true)
                    {
                        ...
                        if(reti != -1)
                        {
                            ...
                            else if(Contact_Fcon_mode == 2)
                            {
                                ...
                                AdaptiveK_msg.Mon1_publish(Mon1_input_data,Mon1_description,true);
                                AdaptiveK_msg.Mon2_publish(Mon2_input_data,Mon2_description,true);
                            ...
                            else if(Contact_Fcon_mode == 4)
                            {
                                ...
                                FAAC3step_msg.Mon1_publish(Mon1_input_data,Mon1_description,true);
                                FAAC3step_msg.Mon2_publish(Mon2_input_data,Mon2_description,true);
                                FAAC3step_msg.Mon3_publish(Mon3_input_data,Mon3_description,true);
                            }
                            else
                            {
                        ...
                        else
                        {
                            ...
                            {
                                UR10e_mode_msg.data = Motion_stop_cmd;
